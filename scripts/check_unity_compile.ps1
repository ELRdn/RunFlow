...
foreach ($dll in @('UnityEngine.CoreModule.dll','UnityEngine.AnimationModule.dll','UnityEngine.AssetBundleModule.dll','RootMotionsScript.dll','umamusume.dll','Plugins.dll','netstandard.dll','Newtonsoft.Json.dll')) {
...
foreach ($name in @('RunFlowSpringBridge.cs','RunFlowCapture.cs','RunFlowBatchDriver.cs','RunFlowMeasurementDriver.cs')) {
